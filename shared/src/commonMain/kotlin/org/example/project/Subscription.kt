...
fun subscribeToService(apiUrl: String, start: Position, end: Position, changeFinalPosition: Position? = null, intervalMillis: Long = 120_000L): Flow<RouteResponse> = flow {
